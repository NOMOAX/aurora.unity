...
namespace Aurora.Unity
{
    ...
    public class BehaviourActiveAndEnabledException : UnityException
    {
        ...
        /// <summary>
        /// 使用指定的行为初始化 <see cref="BehaviourActiveAndEnabledException"/> 类的新实例。
        /// </summary>
        ...
        /// <summary>
        /// 使用指定的行为和错误消息初始化 <see cref="BehaviourActiveAndEnabledException"/> 类的新实例。
        /// </summary>
        /// <param name="behaviour">行为。</param>
        ...
        /// <summary>
        /// 使用指定的行为、错误消息和内部异常初始化 <see cref="BehaviourActiveAndEnabledException"/> 类的新实例。
        /// </summary>
        /// <param name="behaviour">行为。</param>
        /// <param name="message">描述错误的消息。</param>
