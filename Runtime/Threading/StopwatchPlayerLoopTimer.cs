...
{
    /// <summary>
    /// A timer that uses a stopwatch to time and handles non-immediate callbacks in a specific player loop phase.
    /// </summary>
    public sealed class StopwatchPlayerLoopTimer : ITimer, IPlayerLoopItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StopwatchPlayerLoopTimer"/> class.
        /// </summary>
